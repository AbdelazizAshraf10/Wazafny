  ...
  async function handleRegister(values) {
    try {
      ...
      if (response.status === 201) {
        ...
        setTimeout(() => navigate("/EmailConfirm"), 1000);
      } else {
              ...
              <div className="w-1/2 pr-4">
                <div className="relative z-0 w-full mb-2 group">
                  <input
                    ...
                    name="FirstName"
                    id="FirstName"
                    className="block py-2.5 px-0 w-[90%] text-sm text-gray-900 bg-transparent border-0 border-b-[1.77px] border-gray-300 appearance-none dark:border-[#D9D9D9] dark:focus:border-black focus:outline-none focus:ring-0 focus:border-black peer"
                    placeholder=" "
                    required
                  />
                  <label
                ...
                {formik.errors.FirstName && formik.touched.FirstName ? (
                  <div
                    className="text-sm text-red-500 text-left mt-1 mb-2 animate-fadeIn"
              ...
              <div className="w-1/2 pl-4">
                <div className="relative z-0 w-full mb-2 group">
                  <input
                    ...
                    name="LastName"
                    id="LastName"
                    className="block py-2.5 px-0 w-[90%] text-sm text-gray-900 bg-transparent border-0 border-b-[1.77px] border-[#D9D9D9] appearance-none dark:border-[#D9D9D9] dark:focus:border-black focus:outline-none focus:ring-0 focus:border-black peer"
                    placeholder=" "
                    required
                  />
                  <label
                ...
                {formik.errors.LastName && formik.touched.LastName ? (
                  <div
                    className="text-sm text-red-500 text-left mt-1 animate-fadeIn"
