...
import style from "./SignUpCompany.module.css";
    ...
    <>
      ...
      >
        <div className="image w-2/6">
          <img
            className=" scale-125 mt-5 mr-9"
            src="\src\assets\company-sign-up.png"
            alt="frame"
          />
        </div>
        <div className="sign-up p-0">
          ...
          >
            ...
            <div className="login-link">
              <p>
                Already an account?{" "}
                <Link to={"/LoginCompany"} className="link-color " href="#">
                  Login
                </Link>
              </p>
            </div>
            <div className="mt-3 login-link   ">
              <Link to={"/Register"} className="link-color comp">
